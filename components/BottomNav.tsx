...
const BottomNav: React.FC<BottomNavProps> = ({ currentTab, onChangeTab, pendingCount = 0 }) => {
  return (
       ...
       <div className="max-w-md mx-auto px-6 py-2">
         <div className="bg-slate-50 rounded-full p-1.5 flex justify-between items-center relative shadow-inner">
            ...
            <button 
                ...
                className={`flex-1 flex flex-col items-center justify-center py-2 rounded-full transition-all duration-300 ${currentTab === 'settings' ? 'bg-white shadow-sm text-purple-700' : 'text-slate-400 hover:text-slate-600'}`}
            >
